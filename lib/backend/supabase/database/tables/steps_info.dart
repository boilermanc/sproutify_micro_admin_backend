...
class StepsInfoTable extends SupabaseTable<StepsInfoRow> {
  @override
  String get tableName => 'steps_info';

  @override
  StepsInfoRow createRow(Map<String, dynamic> data) => StepsInfoRow(data);
}

class StepsInfoRow extends SupabaseDataRow {
  StepsInfoRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => StepsInfoTable();
