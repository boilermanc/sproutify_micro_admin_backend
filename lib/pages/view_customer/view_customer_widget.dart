...
import 'view_customer_model.dart';
export 'view_customer_model.dart';

class ViewCustomerWidget extends StatefulWidget {
  const ViewCustomerWidget({super.key});

  static String routeName = 'viewCustomer';
  static String routePath = '/viewCustomer';
...
class _ViewCustomerWidgetState extends State<ViewCustomerWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViewCustomerModel());
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          '8q951yw6' /* Use this page to manage your c... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
