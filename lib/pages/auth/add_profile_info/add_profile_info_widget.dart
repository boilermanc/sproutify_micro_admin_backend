...
class AddProfileInfoWidget extends StatefulWidget {
  const AddProfileInfoWidget({super.key});

  static String routeName = 'addProfileInfo';
  static String routePath = '/addProfileInfo';

  @override
  State<AddProfileInfoWidget> createState() => _AddProfileInfoWidgetState();
}
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'w2e78yyx' /* Lets Create Your Profile */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .displaySmall
                                      .override(
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'jb1vcfeh' /* Step Two - Complete the Accoun... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyLarge
                                        .override(
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      context
                                          .pushNamed(AddAFarmWidget.routeName);
                                    },
                                    text: FFLocalizations.of(context).getText(
                                      'ssn9mh8o' /* Create Profile */,
                                    ),
