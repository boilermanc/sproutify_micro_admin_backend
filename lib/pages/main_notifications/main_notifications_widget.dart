                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'xooojxyc' /* Below are your notifications */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 12.0, 0.0, 0.0),
                            child: FutureBuilder<List<NewProfileRow>>(
                              future: NewProfileTable().queryRows(
                                queryFn: (q) => q
                                    .eqOrNull(
                                      'farm_name',
                                      FFAppState().farmName,
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<NewProfileRow> listViewNewProfileRowList =
                                    snapshot.data!;
                                ...
                                return ListView.separated(
                                  ...
                                  itemCount: listViewNewProfileRowList.length,
                                  separatorBuilder: (_, __) =>
                                      SizedBox(height: 8.0),
                                  itemBuilder: (context, listViewIndex) {
                                    final listViewNewProfileRow =
                                        listViewNewProfileRowList[
                                            listViewIndex];
                                    return Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          16.0, 0.0, 16.0, 0.0),
